...
const (
	...
	SERVER_NAME="zhizhi.qrcode";
)


func formatNormalResponceHeaderPng(w http.ResponseWriter) {
	w.Header().Add("server", "zhizhi.qrcode")
	w.Header().Add("Content-Type", "image/png")
}

func formatNormalResponceHeaderText(w http.ResponseWriter) {
	w.Header().Add("server", "zhizhi.qrcode")
